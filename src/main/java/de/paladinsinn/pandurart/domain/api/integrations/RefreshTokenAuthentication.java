...
package de.paladinsinn.pandurart.domain.api.integrations;
 ...
 * @since 2025-10-12
 */
@JsonDeserialize(as = de.paladinsinn.pandurart.domain.model.importers.RefreshTokenAuthentication.class)
