...
import de.paladinsinn.pandurart.domain.api.calendars.CalendarService;
...
public class ICalCalendarService implements CalendarService {
  ...
  public List<Event> getEvents(
      @NotNull final de.paladinsinn.pandurart.domain.api.calendars.Calendar calendar
  ...
  private List<VEvent> readEvents(
      @NotNull final de.paladinsinn.pandurart.domain.api.calendars.Calendar cal,
