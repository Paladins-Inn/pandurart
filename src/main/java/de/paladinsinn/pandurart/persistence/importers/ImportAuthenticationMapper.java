...
package de.paladinsinn.pandurart.persistence.importers;


import de.paladinsinn.pandurart.domain.api.integrations.ImporterAuthentication;
import de.paladinsinn.pandurart.domain.model.importers.RefreshTokenAuthentication;
import de.paladinsinn.pandurart.domain.model.importers.UsernameAndPasswordAuthentication;
...
public interface ImportAuthenticationMapper {
  ...
  default AbstractJpaAuthenticationBase toJpa(final ImporterAuthentication domain) {
    ...
    } else if (domain instanceof de.paladinsinn.pandurart.domain.model.importers.RefreshTokenAuthentication) {
