...
LABEL org.opencontainers.image.title="pandurart" \
      org.opencontainers.image.description="Event Organizing tool" \
      org.opencontainers.image.authors="Roland T. Lichti <rlichti@kaiserpfalz-edv.de" \
      org.opencontainers.image.vendor="Paladins Inn" \
      org.opencontainers.image.url="https://docs.paladins-inn.de/pandurart/dev/manual/index.html" \
      org.opencontainers.image.source="https://github.com/Paladins-Inn/pandurart" \
      org.opencontainers.image.licenses="AGPL-3.0" \
      org.opencontainers.image.base.name="quay.io/paladinsinn/pandurart"
